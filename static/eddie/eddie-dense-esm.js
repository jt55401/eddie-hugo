...
// Generated by widget/build.sh (wasm-pack --target web, eddie-dense); the service workers import this.
/* @ts-self-types="./eddie.d.ts" */
 ...
 * @returns {string}
 */
export function attach_sidecar(bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 */
export function init_dense_wasm(lane_id, config, tokenizer, weights) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(lane_id, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(config, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(tokenizer, wasm.__wbindgen_export2);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passArray8ToWasm0(weights, wasm.__wbindgen_export2);
 ...
 */
export function init_index(index_bytes) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(index_bytes, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
 ...
 */
export function init_sparse_tokenizer(tokenizer_bytes) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(tokenizer_bytes, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {string}
 */
export function manifest(index_bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {string}
 */
export function qa_lookup(query, dense_lane_id, dense_query_vec, k) {
    let deferred5_0;
    let deferred5_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(query, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
        const len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(dense_lane_id) ? 0 : passStringToWasm0(dense_lane_id, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
        var len1 = WASM_VECTOR_LEN;
        var ptr2 = isLikeNone(dense_query_vec) ? 0 : passArrayF32ToWasm0(dense_query_vec, wasm.__wbindgen_export2);
 ...
 * @returns {string}
 */
export function search(query, top_k, mode, dense_lane_id, dense_query_vec) {
    let deferred6_0;
    let deferred6_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(query, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(mode, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
        const len1 = WASM_VECTOR_LEN;
        var ptr2 = isLikeNone(dense_lane_id) ? 0 : passStringToWasm0(dense_lane_id, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
        var len2 = WASM_VECTOR_LEN;
        var ptr3 = isLikeNone(dense_query_vec) ? 0 : passArrayF32ToWasm0(dense_query_vec, wasm.__wbindgen_export2);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('eddie_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();

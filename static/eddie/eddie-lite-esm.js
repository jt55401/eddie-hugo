...
// Generated by widget/build.sh (wasm-pack --target web, eddie-lite); the service workers import this.
/* @ts-self-types="./eddie-lite.d.ts" */
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('eddie-lite_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
